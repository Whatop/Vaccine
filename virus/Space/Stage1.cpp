...
void Stage1::Init() // 스테이지 1 배경 신체로 하고, 스테이지 2의 배경을 숲으로 한다. 근대 숲이라고 초록초록하면 분위기가 안사니 
{
	...
	ObjMgr->AddObject(new BlockMgr(Vec2(1170, 600 + 30), "fast"), "Monster");//스피드 적 1칸
	ObjMgr->AddObject(new BlockMgr(Vec2(1170, 660 + 30), "flash"), "Monster");//점멸 적 1~ 2칸?
 	ObjMgr->AddObject(new BlockMgr(Vec2(1170, 780 + 30), "giant"), "Monster");// 큰 적 2칸으로?
	ObjMgr->AddObject(new BlockMgr(Vec2(1170, 900 + 30), "toxino"), "Monster");// 톡시노 4칸?
